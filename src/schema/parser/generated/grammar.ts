...
// @ts-ignore
  ...
  var peg$e3 = peg$literalExpectation("notEmpty", false);
  var peg$e4 = peg$literalExpectation("empty", false);
  var peg$e5 = peg$literalExpectation("is(", false);
  ...
  var peg$e11 = peg$literalExpectation("length(", false);
  var peg$e12 = peg$literalExpectation("regex(", false);
  var peg$e13 = peg$literalExpectation("integer", false);
  var peg$e14 = peg$literalExpectation("float", false);
  var peg$e15 = peg$literalExpectation("any(", false);
...
// @ts-ignore
 ...
 return value; };// @ts-ignore
  ...
  var peg$f14 = function(leftValue, rightValues) {// @ts-ignore
 return { type: 'any', left: leftValue, right: rightValues, text: text() }; };// @ts-ignore
 ...
 return parseInt(text(), 10); };// @ts-ignore
  ...
  var peg$f18 = function(values) {// @ts-ignore
...
// @ts-ignore
          if (s4 !== peg$FAILED) {
// @ts-ignore
            s5 = peg$parsecolumnValidationExpr();
// @ts-ignore
            if (s5 !== peg$FAILED) {
// @ts-ignore
              peg$savedPos = s0;
...
// @ts-ignore
    if (s1 !== peg$FAILED) {
// @ts-ignore
      s2 = peg$parseandOrWhiteSpaceLiteral();
// @ts-ignore
      if (s2 !== peg$FAILED) {
// @ts-ignore
...
// @ts-ignore
  function // @ts-ignore
peg$parseandOrWhiteSpaceLiteral() {
// @ts-ignore
    var s0, s1, s2, s3, s4;
...
// @ts-ignore
                  if (s0 === peg$FAILED) {
// @ts-ignore
                    s0 = peg$parseintegerExpr();
// @ts-ignore
                    if (s0 === peg$FAILED) {
// @ts-ignore
                      s0 = peg$parsefloatExpr();
// @ts-ignore
                      if (s0 === peg$FAILED) {
// @ts-ignore
                        s0 = peg$parseanyExpr();
...
// @ts-ignore
      s2 = peg$parse_();
// @ts-ignore
      s3 = peg$parseintegerLiteralOrAny();
// @ts-ignore
      if (s3 !== peg$FAILED) {
// @ts-ignore
        s4 = peg$parse_();
...
// @ts-ignore
          s6 = peg$parse_();
// @ts-ignore
          s7 = peg$parseintegerLiteralOrAny();
// @ts-ignore
          if (s7 !== peg$FAILED) {
// @ts-ignore
            s8 = peg$parse_();
...
// @ts-ignore
      s4 = peg$parse_();
// @ts-ignore
      s5 = peg$parsepositiveIntegerOrAny();
// @ts-ignore
      if (s5 !== peg$FAILED) {
// @ts-ignore
        s6 = peg$parse_();
...
// @ts-ignore
      s3 = [];
// @ts-ignore
      s4 = peg$parsecolumnValidationExpr();
// @ts-ignore
      if (s4 !== peg$FAILED) {
// @ts-ignore
        while (s4 !== peg$FAILED) {
...
export type AndOrWhiteSpaceLiteral = [string[], "and", string[]] | string[];
